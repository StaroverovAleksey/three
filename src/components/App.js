...
import Lesson_19 from "./Lesson_19";
...
class App extends React.Component {
    ...
    render = () => {
        ...
        return <Container>
            <Select onChange={this.selectChangeHandler} value={selectValue}>
                ...
                <option>{'Lesson 19'}</option>
                <option>{'Lesson 20'}</option>
                <option>{'Lesson 21'}</option>
            </Select>
            {this.getLesson()}
        </Container>
    }
    ...
    getLesson = () => {
        ...
        switch (selectValue) {
            ...
            case 'Lesson 19': return <Lesson_19/>;
            case 'Lesson 20': return <Lesson_20/>;
            case 'Lesson 21': return <Lesson_21/>;
        }
    }
}
